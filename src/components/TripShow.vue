...
export default {
  ...
  methods: {
    ...
    async fetchTripDetails() {
      try {
        const response = await fetch(`https://camper4fourdev-38684757747e.herokuapp.com/api/trips/${this.$route.params.id}`);
        if (!response.ok) {
    ...
    async rateStop(stop, rating) {
      try {
        ...
        const response = await fetch(`https://camper4fourdev-38684757747e.herokuapp.com/api/stops/${stop.id}/rate`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    async addNote(stopId) {
      try {
        const response = await fetch(`https://camper4fourdev-38684757747e.herokuapp.com/api/stops/${stopId}/notes`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    async deleteNote(noteId) {
      try {
        const response = await fetch(`https://camper4fourdev-38684757747e.herokuapp.com/api/notes/${noteId}`, {
          method: 'DELETE',
        });
